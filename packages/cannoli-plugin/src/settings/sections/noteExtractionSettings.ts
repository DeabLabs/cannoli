...
export function createNoteExtractionSettings(containerEl: HTMLElement, plugin: Cannoli): void {
    // Put header here
    ...
    new Setting(containerEl)
        ...
        .addToggle((toggle) =>
            toggle
                .setValue(
                    plugin.settings.includeFilenameAsHeader || false
                )
    ...
    new Setting(containerEl)
        ...
        .addToggle((toggle) =>
            toggle
                ...
                .onChange(async (value) => {
                    plugin.settings.includePropertiesInExtractedNotes =
                        value;
                    await plugin.saveSettings();
                })
        );
    ...
    new Setting(containerEl)
        ...
        .addToggle((toggle) =>
            toggle
                .setValue(
                    plugin.settings.includeLinkInExtractedNotes ||
                    false
                )
                .onChange(async (value) => {
                    plugin.settings.includeLinkInExtractedNotes =
