...
export function createTranscriptionSettings(containerEl: HTMLElement, plugin: Cannoli, display: () => void): void {
    ...
    new Setting(containerEl)
        ...
        .addToggle((toggle) =>
            toggle
                .setValue(
                    plugin.settings.enableAudioTriggeredCannolis ||
                    false
                )
        ...
        new Setting(containerEl)
            .addTextArea((text) =>
                text
                    ...
                    .setValue(
                        plugin.settings.transcriptionPrompt || ""
                    )
                    .onChange(async (value) => {
