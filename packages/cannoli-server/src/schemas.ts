...
export const HttpServerCreateSchema = HttpServerSchema.omit({ id: true }).partial({ enabled: true });
export const StdioServerCreateSchema = StdioServerSchema.omit({ id: true }).partial({ enabled: true });
