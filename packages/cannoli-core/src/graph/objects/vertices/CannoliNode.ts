...
import { Reference, VerifiedCannoliCanvasFileData, VerifiedCannoliCanvasLinkData, VerifiedCannoliCanvasTextData, VerifiedCannoliCanvasData, ReferenceType, GroupType, CannoliObjectStatus, ContentNodeType, EdgeModifier, EdgeType } from "src/graph";
...
export type VariableValue = { name: string; content: string; edgeId: string | null };
