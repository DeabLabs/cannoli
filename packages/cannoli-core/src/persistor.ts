...
export const canvasFileDataSchema = canvasNodeDataSchema.merge(
  z.object({
    type: z.literal("file"),
    file: z.string(),
...
const canvasTextDataSchema = canvasNodeDataSchema.merge(
  z.object({
    type: z.literal("text"),
    text: z.string(),
  }),
...
export const canvasLinkDataSchema = canvasNodeDataSchema.merge(
  z.object({
    type: z.literal("link"),
    url: z.string(),
  }),
...
export const canvasGroupDataSchema = canvasNodeDataSchema.merge(
  z.object({
    type: z.literal("group"),
    label: z.string().optional(),
    background: z.string().optional(),
    backgroundStyle: z
      .union([z.literal("cover"), z.literal("ratio"), z.literal("repeat")])
      .optional(),
  }),
);
...
export const nodeSideSchema = z.union([
  z.literal("top"),
  z.literal("right"),
  z.literal("bottom"),
  z.literal("left"),
...
export const allCanvasNodeDataSchema = z.union([
  canvasFileDataSchema,
  canvasTextDataSchema,
  canvasLinkDataSchema,
  canvasGroupDataSchema,
]);

export type AllCanvasNodeData = z.infer<typeof allCanvasNodeDataSchema>;

export const canvasEdgeDataSchema = z
  .object({
    id: z.string(),
    fromNode: z.string(),
...
export interface Persistor {
  ...
  editOriginalParallelGroupLabel(
